...
// Lightweight replacement for Lucide icons used in the app
// to reduce Cloudflare Worker bundle size.
...
export const Map = (props: any) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14.106 5.553a2 2 0 0 0 1.788 0l2.36-1.18a2 2 0 0 1 1.789 0L22 5.309V19c0 .75-.5 1.5-1.5 1.5-1.5 0-3-1.5-4-1.5s-2.5 1.5-4 1.5-2.5-1.5-4-1.5-3 1.5-4.5 1.5c-1 0-1.5-.75-1.5-1.5V5.309l2.253-1.127a2 2 0 0 1 1.79 0l4.21 2.105a2 2 0 0 0 1.79 0l2.004-1.002z" />
        <path d="M15 5.5v13" />
        <path d="M9 5.5v13" />
    </svg>
);
